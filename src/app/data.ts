...
export class Producto{
  ...
  constructor( imagen: string = "", texto1: string = "", texto2: string = "", precio: number = 0, indice: number = 1, oferta: boolean = false, imperdible: boolean = false, comprado: boolean = true, cantidad: number = 0){
    this.imagen     = imagen;
    this.texto1     = texto1;
    this.texto2     = texto2;
    this.precio     = precio;
