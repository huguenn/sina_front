...
export class SharedService {
  ...
  updatePageTitle($title:string = 'Articulos de limpieza por mayor, articulos de bazar | Sina', $meta_content:string = 'Fábrica, mayorista y distribuidora de artículos de limpieza y bazar con entrega a todo el país, hacé tu pedido online!'){
    /**
